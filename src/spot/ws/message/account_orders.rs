...
#[serde(untagged)]
pub(crate) enum RawAccountOrdersChannelMessageData {
    LimitOrMarket(RawLimitOrMarketAccountOrdersChannelMessageData),
    StopLimit(RawStopLimitAccountOrdersChannelMessageData),
}

#[allow(non_snake_case)]
#[derive(Debug, serde::Deserialize)]
pub(crate) struct RawLimitOrMarketAccountOrdersChannelMessageData {
    pub A: Decimal,
...
#[allow(non_snake_case)]
#[derive(Debug, serde::Deserialize)]
pub(crate) struct RawStopLimitAccountOrdersChannelMessageData {
    pub N: String,
    #[serde(with = "chrono::serde::ts_milliseconds")]
    pub O: DateTime<Utc>,
    pub P: Decimal,
